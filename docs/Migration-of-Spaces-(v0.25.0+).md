...
1. Before starting migration, you may want to make a backup by zipping or
   ...
   [user data](https://github.com/philrz/scratchwiki/wiki/Filesystem-Paths#user-data-all-versions)
   path.
...
and speak up, or [open an issue](https://github.com/philrz/scratchwiki/wiki/Troubleshooting#opening-an-issue).
Thanks!
