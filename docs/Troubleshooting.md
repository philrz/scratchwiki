...
> [this article](https://github.com/philrz/scratchwiki/wiki/Troubleshooting-%28v0.25.0-%29).
...
found in the `zdeps` directory under the Brim [application binaries](https://github.com/philrz/scratchwiki/wiki/Filesystem-Paths#application-binaries-v0240)
path.
