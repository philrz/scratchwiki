...
> [this article](https://github.com/philrz/scratchwiki/wiki/Troubleshooting).
...
`logs` subdirectory under the Brim [user data](https://github.com/philrz/scratchwiki/wiki/Filesystem-Paths#user-data-all-versions)
path.
